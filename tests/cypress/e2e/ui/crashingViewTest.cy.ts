...
describe('Error handling test during JS view execution', () => {
    before('Create test contents', () => {
        addSimplePage('/sites/npmTestSite/home', 'testCrashingViewReact', 'testCrashingViewReact', 'en', 'simple', [
            {
                name: 'pagecontent',
    ...
    const testConfig = {
        ...
        viewKey: 'default',
        viewPath: '/jahia-npm-module-example_view_npmExample:testCrashingView_default',
