describe('Test on getNode helper', () => {
    it('Check currentContent injected JSON node in current view', function () {
        ...
        cy.get('div[data-testid="currentContent_path"]').should('contain', '/sites/npmTestSite/home/testPage/pagecontent/test')
        cy.get('div[data-testid="currentContent_parent"]').should('contain', '/sites/npmTestSite/home/testPage/pagecontent')
