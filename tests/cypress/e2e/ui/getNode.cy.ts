describe('Test on getNode helper', () => {
    it('Check currentNode injected JSON node in current view', function () {
        ...
        cy.get('div[data-testid="currentNode_properties_propMultiple"]').should('contain', '[value 1, value 2, value 3]')
        cy.get('div[data-testid="currentNode_name"]').should('contain', 'test')
        cy.get('div[data-testid="currentNode_path"]').should('contain', '/sites/npmTestSite/home/testPage/pagecontent/test')
        cy.get('div[data-testid="currentNode_parent"]').should('contain', '/sites/npmTestSite/home/testPage/pagecontent')
    ...
    it('Check getNode helper with includeChildren', function () {
        ...
        cy.get('div[data-testid="getNode_site_withChildren_contents_path"]').should('contain', '/sites/npmTestSite/contents')
